...
class funap(gym.Env):
    ...
    def __init__(self,noise=0.1, terminal_reward=10.0, border_reward = 0.0, st_state=[6,7,35,36],confusion=0.1,rew1 =-1,rew2 = -2,rew3 = -3,p1 = [39,40,41,42,43,44,45,51,57,63,69,75,81,87,91,92,93,99,100,101,102,103],p2 = [52,53,54,55,56,64,68,76,78,79,80,88,89,90],p3 = [65,66,67,77],term_state = [133]):
        self.UP = 0
        self.RIGHT = 1
        self.DOWN = 2
        self.LEFT = 3      
